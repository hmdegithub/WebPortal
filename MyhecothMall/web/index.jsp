        ...
        <div class="header_bottom-box">
            ...
            <div class="header_bottom_right">
                ...
                <ul class="bag">
                    ...
                    <a href="#">
                        <li class="bag_right"><p>205.00 $</p></li>
                    </a>
                    <div class="clearfix"></div>
                </ul>
            </div>
    ...
    <div class="container">
        <div class="menu_box">
            <ul class="megamenu skyblue">
                <li class="active grid"><a class="color2" href="index.jsp">Home</a></li>
            ...
            <div class="col-md-3 span_6">
                <div class="box_inner">
                    ...
                    <div class="desc">
                        ...
                        <h4>178,90 $</h4>
                        <ul class="list2">
                            <li class="list2_left"><span class="m_1"><a href="#" class="link">Add to Cart</a></span>
                            </li>
...
<div class="footer">
    <div class="container">
        ...
        <p class="copy">Copyright &copy; 2016.Company name All rights reserved.<a target="_blank"
